...
from models.results import ConversionResult, DownloadResult
...
def main() -> None:
    ...
    if args.command == "worker-command":
        print("uv run celery -A pipeline.celery_app:celery_app worker --loglevel=INFO --pool=solo")
        return
...
def _doctor() -> dict[str, Any]:
    from pipeline.orchestrator import celery_worker_available
